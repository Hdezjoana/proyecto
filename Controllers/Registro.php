...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($usuario) || empty($correo) || empty($contraseña) || empty($contraseña_rev)) {
        ...
        header("Location: ../Views/Registro_formulario.php?error=campos_vacios");
        exit();
    }
    ...
    if ($contraseña !== $contraseña_rev) {
        ...
        header("Location: ../Views/Registro_formulario.php?error=contraseñas_no_coinciden");
        exit();
    }
...
function registrarUsuario($usuario, $correo, $contraseña) {
    ...
    $consulta = "INSERT INTO usuarios (correo, contraseña, nombre) VALUES (?, ?, ?)";
